...
class User_Model extends CI_Model
{
    ...
    {
    	$query = $this->db->query("SELECT users.first_name, users.username, users_colleges.user_id, users.last_name,users.last_login,users.created_on,colleges.description AS college,groups.name as role 
