        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Candidates</h1>
            <div class="fade-on-load" hidden>
                ...
                <?php
                  $candidateLink = (!$this->ion_auth->in_group('candidates')) ? '<a href="' . site_url('notifications/SendCandidateNotification/') . '" class="btn btn-primary" role="button">Become a Candidate</a>' : ' ';
                ?>
                <?=$candidateLink?>
