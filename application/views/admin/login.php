        ...
        <div class="col-xs-12">
          <div class="panel panel-default panel-user-auth block-center">
            ...
            <?php if($message != NULL):?>
            	<?php echo $message;?>
            <?php endif; ?>
              <form method="post" accept-charset="utf-8" action="<?=site_url('admin/login')?>" id="login" role="form">
                <div class="form-group">
                  <label>EUID</label>
                  <input name="identity" id="identity" type="text" class="form-control" placeholder="UNT EUID" tabindex="1" autofocus>
                </div>
                <div class="form-group">
                  <label>Password <?=anchor('admin/forgot_password', '(Forgot?)', array('tabindex' => '-1'))?></label> 
